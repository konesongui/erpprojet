...
class Project_model extends CI_Model{
    ...
    public function GetProjectsValue(){
		...
		public function GetClientsValue(){
    ...
    public function GetAssetsCategory(){
		...
		public function GetCaissesCategory(){
			$sql = "SELECT * FROM `caisses_category`";
			$query=$this->db->query($sql);
			$result = $query->result();
			return $result;
		}
    ...
    public function GetLogisTicValue($id){
		...
		public function GetDepensesValue($id){
			$sql = "SELECT * FROM `depenses` WHERE `ass_id`='$id'";
			$query=$this->db->query($sql);
			$result = $query->result();
			return $result;
		}
    ...
    public function Update_Assets($id,$data){
		...
		public function Update_Caisses($id,$data){
			$this->db->where('ass_id',$id);
			$this->db->update('caisses',$data);
		}

		public function Update_Depenses($id,$data){
			$this->db->where('ass_id',$id);
    ...
    $sql = "SELECT `logistic_assign`.*,
      ...
      WHERE `logistic_assign`.`project_id`='$id'";
		...
		public function GetAllDepenses($id){
			$sql = "SELECT `depenses`.*,
      `employee`.`em_id`,`first_name`,`last_name`,
      `caisses`.`ass_name`
      FROM `depenses`
      LEFT JOIN `employee` ON `depenses`.`assign_id`=`employee`.`em_id`
      LEFT JOIN `caisses` ON `depenses`.`asset_id`=`caisses`.`ass_id`
      WHERE `depenses`.`project_id`='$id'";
			$query=$this->db->query($sql);
			$result = $query->result();
			return $result;
		}
    ...
    public function Add_Assets($data){
		...
		public function Add_Caisses($data){
			$this->db->insert('caisses',$data);
		}
    ...
    public function GetAllAssetsList(){
		...
		public function GetAllCaissesList(){
			$sql = "SELECT `caisses`.*,
        `caisses_category`.*
        FROM `caisses`
        LEFT JOIN `caisses_category` ON `caisses`.`catid`=`caisses_category`.`cat_id`";
			$query=$this->db->query($sql);
			$result = $query->result();
			return $result;
		}
		...
		public function caisseselect(){
			$sql = "SELECT * FROM `caisses` WHERE `status`='ACTIVE'";
		...
		public function GetAllDepensesList(){
			$sql = "SELECT `depenses`.*,
        `category`.*
        FROM `depenses`
        LEFT JOIN `category` ON `depenses`.`category_id`=`category`.`category_id`";
			$query=$this->db->query($sql);
			$result = $query->result();
			return $result;
		}
    ...
    public function GetAssetsQty($id){
		...
		public function GetCaissesQty($id){
			$sql = "SELECT * FROM `caisses` WHERE `ass_id`='$id'";
			$query=$this->db->query($sql);
			$result = $query->row();
			return $result;
		}
    ...
    public function DeletAssetssByid($id){
		...
		public function DeletCaissesByid($id){
			$this->db->delete('caisses',array('id'=> $id));
		}
