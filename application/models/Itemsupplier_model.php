...
class Itemsupplier_model extends MY_Model {
    ...
    public function adds($data) {
        ...
        if (isset($data['id'])) {
            $this->db->where('id', $data['id']);
            $this->db->update('caisse_supplier', $data);
            ...
            $this->db->insert('caisse_supplier', $data);
            $insert_id = $this->db->insert_id();
    ...
    public function removes($id) {
        ...
        //=======================Code Start===========================
        $this->db->where('id', $id);
        $this->db->delete('caisse_supplier');
        $message = DELETE_RECORD_CONSTANT . " On caisse supplier id " . $id;
        $action = "Delete";
        $record_id = $id;
        $this->log($message, $record_id, $action);
        //======================Code End==============================
