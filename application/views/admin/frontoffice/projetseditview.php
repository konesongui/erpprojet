<div class="content-wrapper" style="min-height: 348px;">  
    ...
    <section class="content">       
        <div class="row">
            <?php if ($this->rbac->hasPrivilege('subject', 'can_add') || $this->rbac->hasPrivilege('subject', 'can_edit')) { ?>
                <div class="col-md-4">
                    <!-- Horizontal Form -->
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/projets/edit/' . $visitor_data['id']) ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() ?>admin/projets" type="button" class="btn btn-primary btn-xs" style="width: 99px;height: 23px">
                                            ...
                                            <tr>
                                                ...
                                                <td class="mailbox-date pull-right">
                                                   <!-- <a  data-placement="left" onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs" data-target="#visitordetails" data-toggle="modal"  title="<?php echo $this->lang->line('view') ?>"><i class="fa fa-reorder"></i></a> -->
                                                    ...
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/projets/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                                    ...
                                                    <?php } else { ?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/projets/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                            <i class="fa fa-remove"></i>
                                                        </a>
                                                    <?php } ?>
                                                </td>
