            ...
            <?php if ($this->rbac->hasPrivilege('subject', 'can_add')) {?>
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/projets') ?>"   method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="box-body">
...
?>">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="download_label">Liste des projets</div>
...
if (empty($visitor_list)) {
    ...
    foreach ($visitor_list as $key => $value) {
                                               ...
                                               <!-- <td class="mailbox-name"><?php echo $value['contact']; ?> </td>-->
                                                ...
                                                <td class="mailbox-date pull-right white-space-nowrap">
                                                   <!-- <a data-placement="left"  onclick="getRecord(<?php echo $value['id']; ?>)" class="btn btn-default btn-xs" data-target="#visitordetails" data-toggle="modal"  title="<?php echo $this->lang->line('view'); ?>"><i class="fa fa-reorder"></i></a>-->
                                                    <?php if ($value['image'] !== "") {?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/projets/download/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>  <?php }?>
                                                    <?php if ($this->rbac->hasPrivilege('subject', 'can_edit')) {?>
                                                        <a data-placement="left" href="<?php echo base_url(); ?>admin/projets/edit/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
        ...
        ?>
            ...
            ?>
                                                        <?php if ($value['image'] !== "") {?><a data-placement="left" href="<?php echo base_url(); ?>admin/projets/imagedelete/<?php echo $value['id']; ?>/<?php echo $value['image']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } else {?>
                                                            <a data-placement="left" href="<?php echo base_url(); ?>admin/projets/delete/<?php echo $value['id']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                            <?php
}
...
<script type="text/javascript">
                                                                ...
                                                                function getRecord(id) {
                                                                    $.ajax({
                                                                        url: '<?php echo base_url(); ?>admin/projets/details/' + id,
