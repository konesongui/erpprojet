                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-horizontal">
                                           ...
                                           <!-- <div class="checkbox" hidden>
                                                <label><input hidden type="checkbox" name="visible[]" value="student" <?php echo set_checkbox('visible[]', 'student', false) ?> /><b><?php echo $this->lang->line('student'); ?></b> </label>
                                        </div>
                                        <<div class="checkbox">
                                            <label><input hidden type="checkbox" name="visible[]"  value="parent" <?php echo set_checkbox('visible[]', 'parent', false) ?> /> <b><?php echo $this->lang->line('parent'); ?></b></label>
                                        </div>-->
                                            <?php
