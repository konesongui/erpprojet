                            ...
                            <div class="tshadow mb25 bozero">    
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Cnps N°</label>
                                                <input id="cnps_no" name="cnps_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('cnps_no', $staff["cnps_no"]); ?>" />
                                            ...
                                            <div class="row around10">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?php echo $staff["sursalaire"] ?>" class="form-control" name="sursalaire" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime d'anciennété</label>
                                                        <input type="text" value="<?php echo $staff["prime_anc"] ?>" class="form-control" name="prime_anc" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime de transport</label>
                                                        <input type="text" value="<?php echo $staff["prime_trans"] ?>" class="form-control" name="prime_trans" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Forfait d'heure supplémentaire</label>
                                                        <input type="text" value="<?php echo $staff["forfait_hs"] ?>" class="form-control" name="forfait_hs" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime de responsabilité</label>
                                                        <input type="text" value="<?php echo $staff["prime_resp"] ?>" class="form-control" name="prime_resp" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Bonus</label>
                                                        <input type="text" value="<?php echo $staff["bonus"] ?>" class="form-control" name="bonus" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime de rendement</label>
                                                        <input type="text" value="<?php echo $staff["prime_rend"] ?>" class="form-control" name="prime_rend" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime de risque</label>
                                                        <input type="text" value="<?php echo $staff["prime_risque"] ?>" class="form-control" name="prime_risque" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime d'assiduité</label>
                                                        <input type="text" value="<?php echo $staff["prime_assi"] ?>" class="form-control" name="prime_assi" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Prime Gratification</label>
                                                        <input type="text" value="<?php echo $staff["prime_grati"] ?>" class="form-control" name="prime_grati" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Congé </label>
                                                        <input type="text" value="<?php echo $staff["conge"] ?>" class="form-control" name="conge" >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="<?php echo $staff["imp_sal"] ?>" class="form-control" name="imp_sal" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Contribution Nationale (CN)</label>
                                                        <input type="text" value="<?php echo $staff["contra_nat"] ?>" class="form-control" name="contra_nat" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Imp. Gén. sur Revenu (IGR) </label>
                                                        <input type="text" value="<?php echo $staff["imp_revenu"] ?>" class="form-control" name="imp_revenu" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Cont. Recons. Nat. (CRNS)</label>
                                                        <input type="text" value="<?php echo $staff["crns"] ?>" class="form-control" name="crns" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">CMU </label>
                                                        <input type="text" value="<?php echo $staff["cmu"] ?>" class="form-control" name="cmu" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">CNPS, Régime de Retraite</label>
                                                        <input type="text" value="<?php echo $staff["cnps_regim"] ?>" class="form-control" name="cnps_regim" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">CNPS, Accident Travail</label>
                                                        <input type="text" value="<?php echo $staff["cnps_tra"] ?>" class="form-control" name="cnps_tra" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">CNPS, Prest. Famil.</label>
                                                        <input type="text" value="<?php echo $staff["cnps_pres"] ?>" class="form-control" name="cnps_pres" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">FDFP, Taxe Apprentissage </label>
                                                        <input type="text" value="<?php echo $staff["fdfp_taxe"] ?>" class="form-control" name="fdfp_taxe" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">FDFP, Form. Prof. Continue </label>
                                                        <input type="text" value="<?php echo $staff["fdfp_form"] ?>" class="form-control" name="fdfp_form" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Avance/Acompte</label>
                                                        <input type="text" value="<?php echo $staff["avan_acom"] ?>" class="form-control" name="avan_acom" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Autres retenues</label>
                                                        <input type="text" value="<?php echo $staff["autre_reve"] ?>" class="form-control" name="autre_reve" >
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Tax</label>
                                                        <input type="text" value="<?php echo $staff["tax"] ?>" class="form-control" name="tax" >
                                                    </div>
                                                </div>
