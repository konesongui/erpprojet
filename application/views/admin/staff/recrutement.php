            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix">recrutement </h3>
                        <div class="box-tools pull-right">
                            <?php if ($this->rbac->hasPrivilege('recrutement', 'can_add')) { ?>
                                <small class="pull-right"><a href="#addtraining" onclick="addTraining()" role="button" class="btn btn-primary btn-sm checkbox-toggle pull-right edit_setting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing">Ajouter une formation</a></small>
                            <?php } ?>
                        </div>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                                ...
                                <div class="tab-pane active table-responsive no-padding">
                                    ...
                                    <table class="table table-striped table-bordered table-hover example">
                                      ...
                                      <!--  <th><?php echo $this->lang->line('status'); ?></th>-->
                                        ...
                                        <?php
                                        $i = 0;
                                        foreach ($recrutement as $key => $value) {
                                            ?>
                                            <tr>
