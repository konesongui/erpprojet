...
<?php if($staff['user_type']=='Teacher'){ ?>
                        ...
                        <ul class="list-group list-group-unbordered">
                          ...
                          <!--  <li class="list-group-item listnoback">
                                ...
                                <li class="list-group-item listnoback">
                                    <b>Cnps</b> <a class="pull-right text-aqua"><?php echo $staff['cnps_no']; ?></a>
                                </li>
							<?php } ?>
                            <li class="list-group-item listnoback">
                         ...
                         <div class="modal-body pt0 pb0">   
                            ...
                            <div id='timeline_hide_show'>                                                    
                                ...
                                <div class="">
                                    ...
                                    <div class="form-group">
                                        <label for="">Date de fin</label><small class="req"> *</small>
                                        <input id="enddate" name="enddate" value="<?php echo set_value('enddate', date($this->customlib->getSchoolDateFormat())); ?>" placeholder="" type="text" class="form-control date"  />
