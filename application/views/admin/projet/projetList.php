            ...
            if ($this->rbac->hasPrivilege('subject', 'can_add')) {
                ...
                <div class="col-md-4">          
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo site_url('admin/projet') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="startdate" name="startdate" placeholder="" type="date" class="form-control"  value="<?php echo set_value('startdate'); ?>" />
                                    <span class="text-danger"><?php echo form_error('startdate'); ?></span>
                                </div>
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1">Date fin</label>
                                    <input id="enddate" name="enddate" placeholder="" type="date" class="form-control"  value="<?php echo set_value('enddate'); ?>" />
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <textarea id="description" name="description" placeholder="" type="text" class="form-control"  value="<?php echo set_value('description'); ?>" /></textarea>
