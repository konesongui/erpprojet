            ...
            if ($this->rbac->hasPrivilege('subject', 'can_add') || $this->rbac->hasPrivilege('subject', 'can_edit')) {
                ...
                <div class="col-md-4">            
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url("admin/projet/edit/" . $id) ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group"><br>
                                    ...
                                    <input id="startdate" name="startdate" placeholder="" type="text" class="form-control"  value="<?php echo set_value('startdate', $subject['startdate']); ?>" />
                                    <span class="text-danger"><?php echo form_error('startdate'); ?></span>
                                </div>
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1">Date fin</label>
                                    <input id="enddate" name="enddate" placeholder="" type="text" class="form-control"  value="<?php echo set_value('enddate', $subject['enddate']); ?>" />
                                    <span class="text-danger"><?php echo form_error('enddate'); ?></span>
                                </div>
                                <div class="form-group"><br>
                                    <label for="exampleInputEmail1">Détails</label>

                                    <input id="description" name="description" placeholder="" type="text" class="form-control"  value="<?php echo set_value('description', $subject['description']); ?>" />
                                ...
                                <tbody>
                                    ...
                                    foreach ($subjectlist as $subject) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name"><?php echo $subject['startdate'] ?></td>
                                            <td class="mailbox-name"><?php echo $subject['enddate'] ?></td>
                                            <td class="mailbox-name"><?php echo $subject['description'] ?></td>
                                           <!-- <td class="mailbox-name"><#?php echo ucfirst($subject['type']) ?></td>-->
                                            <td class="mailbox-date pull-right no-print">
                                                <?php
                                                if ($this->rbac->hasPrivilege('projet', 'can_edit')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/projet/edit/<?php echo $subject['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('projet', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/projet/delete/<?php echo $subject['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
