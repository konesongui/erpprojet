        ...
        <div class="row">        
            <div class="col-md-4">             
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('admin/projet/create') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        <div class="box-body">
                            ...
                            <label class="radio-inline" hidden>
                                <input type="radio" value="Active" name="type"  <?php if (set_value('type') == "Active") echo "checked"; ?> checked><?php echo $this->lang->line('theory'); ?>
                            </label>
                            <label class="radio-inline" hidden>
                                <input type="radio" name="type" <?php if (set_value('type') == "Inactive") echo "checked"; ?> value="Inactive"><?php echo $this->lang->line('practical'); ?>
                            </label>
                            <div class="form-group">
