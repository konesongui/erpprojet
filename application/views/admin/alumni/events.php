...
?>
                        ...
                        <div class="form-group col-md-12">
                            <label>Titre</label><small class="req"> *</small>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" autocomplete="off" id="timeline" name="timeline" class="form-control" >

                        </div>
                        <div class="form-group col-md-6">
                            <label for="exampleInputEmail1">Année</label><small class="req"> *</small>
