                            ...
                            <div class="box-body">
                                ...
                                <div class="upload_content <?php echo $content_disable; ?>">
                                    <!--<div class="checkbox" hidden>
                                         <label><input hidden type="checkbox" value="Yes" name="visibility" id="chk" <?php if (set_value('visibility') == "Yes") echo "checked=checked"; ?>/><b><?php echo $this->lang->line('available_for_all_classes'); ?> </b></label>
                                    </div>-->
