    ...
    if ($this->rbac->hasPrivilege('enquiry_overview_widegts', 'can_view')) {
        ?>
                    <div class="col-md-3 col-sm-6">
                        ...
                        <div class="topprograssstart">
                            <h5 class="pro-border pb10"> Aperçu des demandes</h5>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="info-box">
                <a href="#">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Demande de congé en cours</span>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="info-box">
                <a href="<?php echo site_url('admin/expense') ?>">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Nombre de fornisseurs</span>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/search') ?>">
                                        ...
                                        <div class="info-box-content">
                            Fees Collection                <span class="info-box-text"><?php echo $this->lang->line('student'); ?></span>
