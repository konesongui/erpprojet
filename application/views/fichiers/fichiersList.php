            ...
            if ($this->rbac->hasPrivilege('section', 'can_add')) {
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        ...
                        <form action="<?php echo site_url('fichiers/index') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div><input class="filestyle form-control" type='file' name='documents'  />
                                    </div>
                                    <span class="text-danger"><?php echo form_error('documents'); ?></span></div>
                                ...
                                <tbody>                                   
                                    ...
                                    foreach ($sectionlist as $section) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="mailbox-name" dow> <?php echo $section['documents'] ?>
                                                <?php if ($value['documents'] !== "") {?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>admin/files/download/<?php echo $value['documents']; ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('download'); ?>">
                                            ...
                                            <td class="mailbox-date pull-right">
                                                ...
                                                if ($this->rbac->hasPrivilege('section', 'can_edit')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>fichiers/edit/<?php echo $section['id'] ?>" class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                                                ...
                                                if ($this->rbac->hasPrivilege('section', 'can_delete')) {
                                                    ?>
                                                    <a data-placement="left" href="<?php echo base_url(); ?>fichiers/delete/<?php echo $section['id'] ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('Section will also delete all students under this Section so be careful as this action is irreversible --r');">
