       ...
       /* if ($this->rbac->hasPrivilege('teachers_time_table', 'can_view')) {
        ...
        /*if ($this->rbac->hasPrivilege('subject', 'can_view')) {
            ?>
                            ...
                            if ($this->rbac->hasPrivilege('subject', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('admin/projets'); ?>"><a href="<?php echo base_url(); ?>admin/projets"><i class="fa fa-angle-double-right"></i>Gestion de projets</a></li>
                    ...
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('approve_leave_request', 'can_view')) {
                                ?>
                                <a href="#">
                                    <i class="fa fa-sitemap ftlayer"></i> <span style="color: white;margin: 13px">Congés</span> <i class="fa fa-angle-left pull-right"></i>
                                </a>
                            <ul class="treeview-menu">
